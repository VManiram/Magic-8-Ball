...
function answerQuestion() {
  ...
  let possibleAnswers = ["It is certain", "Without a doubt",
  "Ask again later", "Reply hazy, try again", "Don't count on it", "Outlook not good"];

  let random = getRandomIntInclusive(0,5);
  console.log(random);
  makeAnswerAppear(possibleAnswers[random]);
